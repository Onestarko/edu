<?php /* Smarty version Smarty-3.1.6, created on 2016-07-10 16:37:32
         compiled from "./Admin/Tpl\Libcom\index.html" */ ?>
<?php /*%%SmartyHeaderCode:234175782094ce5ffa7-71117093%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f563976a4deb5ca30924030bf3e94275b7217d7c' => 
    array (
      0 => './Admin/Tpl\\Libcom\\index.html',
      1 => 1454382011,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '234175782094ce5ffa7-71117093',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5782094d0b5df',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5782094d0b5df')) {function content_5782094d0b5df($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
	...
	<div class="searchBar">
		<table class="searchContent">
            <tr>
                 <td>搜索：</td>
				<td>
                    评论用户：<input type="text" name="username" size="8" value="<?php echo $_POST['username'];?>
"/>
                </td>
                <td>
                    资源名：<input type="text" name="title" size="8" value="<?php echo $_POST['title'];?>
"/>
                </td>
                <td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="__URL__/delete/id/{sid_user}/navTabId/listlibcom" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="__URL__/edit/id/{sid_user}/navTabId/listlibcom" target="dialog"><span>查看内容</span></a></li>
...
<?php }?>>ID号</th>
                ...
                <th align="center" width="40">评论资源</th>
...
">
                ...
                <!--<td><?php if ($_smarty_tpl->tpl_vars['vo']->value['status']==1){?>未审核<?php }else{ ?>已审核<?php }?></td>-->
            </tr>
            <?php } ?>
