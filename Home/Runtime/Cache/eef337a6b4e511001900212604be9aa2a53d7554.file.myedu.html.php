<?php /* Smarty version Smarty-3.1.6, created on 2016-07-10 18:47:03
         compiled from "./Home/Tpl\Users\myedu.html" */ ?>
<?php /*%%SmartyHeaderCode:153065780bbbb0a3e00-36616988%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '153065780bbbb0a3e00-36616988',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5780bbbb701c3',
  'variables' => 
  array (
    'collnum' => 0,
    'collect' => 0,
...
<?php if ($_valid && !is_callable('content_5780bbbb701c3')) {function content_5780bbbb701c3($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
">查看详情</a></li>
                        ...
                        <?php }else{ ?>
                        <div class="null">
                            还没有学习视频，去 <a href="__APP__/Video/index">这里</a> 看看有没有适合你的视频资源吧
                        </div>
                        <?php }?>
                        </ul>   
                    </div>
...
">查看详情</a></li>
                        ...
                        <?php }else{ ?>
                        <div class="null">
                           还没有收藏，去 <a href="__APP__/Library/index">这里</a> 看看有没有适合你的文档资源吧
                        </div>
                        <?php }?>
                        </ul>   
                    </div>
