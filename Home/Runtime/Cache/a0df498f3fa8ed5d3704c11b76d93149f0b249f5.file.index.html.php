<?php /* Smarty version Smarty-3.1.6, created on 2016-07-08 23:53:23
         compiled from "./Home/Tpl\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:13054577fcc7306e320-69753409%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '13054577fcc7306e320-69753409',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_577fcc738152a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_577fcc738152a')) {function content_577fcc738152a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        
        <title>在线物理实验平台</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav g_nav">
                        <li><a href="__APP__/Video/index" class="btn btn-primary btn-signup animated">实验模拟</a></li>
                        ...
                        <?php if ($_SESSION['user']){?>
                            <li><a href="__APP__/Test/index" class="btn btn-primary btn-signup animated">在线测验</a></li>
                            <?php }else{ ?>
                            <li><a href="javascript:alert('请先登录！')" class="btn btn-primary btn-signup animated">在线测验</a></li>
                            <?php }?>
                    </ul>
...
"><?php echo $_smarty_tpl->tpl_vars['vcat']->value['name'];?>
                    ...
                    <div class="m_pay_list">
                        <div class="tt">
                            <h3 style="color:#6C6767">实验点击榜</h3>
                            <a href="__APP__/Video/index" class="more">更多 »</a>
                        </div>
                        <ol>
...
" style='color:#C993D1' target='blank'><?php echo $_smarty_tpl->tpl_vars['qv']->value['username'];?>
         ...
         <div id="footer">
            <div class="container">
                <div class="col-md-2">
                   <a href="__APP__/Index/index"><img alt="在线物理实验" title="在线物理实验" src="__PUBLIC__/images/logo-bq.png"></a>
                </div>
