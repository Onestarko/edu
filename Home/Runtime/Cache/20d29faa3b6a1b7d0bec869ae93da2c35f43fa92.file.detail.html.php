<?php /* Smarty version Smarty-3.1.6, created on 2016-12-08 09:09:56
         compiled from "./Home/Tpl\Video\detail.html" */ ?>
<?php /*%%SmartyHeaderCode:19039577fcc78726e35-92001760%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19039577fcc78726e35-92001760',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_577fcc78b22ae',
  'variables' => 
  array (
    'vo' => 0,
    'collnum' => 0,
...
<?php if ($_valid && !is_callable('content_577fcc78b22ae')) {function content_577fcc78b22ae($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>实验资源浏览</title>
...
" class="btn btn-success btn-sm"><i class="icon-play"></i> 在线观看视频</a>               
                                        <?php if ($_SESSION['user']){?>
...
<div id="short-review-modal" tabindex="2" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="huifus">
...
">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea name="content" id="" class="form-control charsFrom" rows="3" id="short_content"></textarea>
            ...
            if (!content.trim()) {
               ...
               $.ajax({
                    ...
                    success:function(data){
                       ...
                       // str += "<a href='__APP__/Users/otheredu/uid/"+uid+">'><img alt='"+username+"' title='"+username+"' src='__PUBLIC__/Uploads/users/"+username+"/s_"+picture+"' class='avatar_md'></a>";
                      //  str += "<a href='__APP__/Users/otheredu/uid/'"+uid+" target=\"_blank\">"+username+"</a> "+addtime+"</div>";
                       //str += "<p><i class=\"icon-quote-left cccc\"></i>"+content+"<i class=\"icon-quote-right cccc\"></i></p></div>";
                       // str += "</li>";
                        ...
                        $("#comment").append("<li><div class=\"reviews_b\"><div class=\"c999 m_n_item_info f12 bg_fff\"><p><i class=\"icon-quote-left cccc\"></i>"+content+"<i class=\"icon-quote-right cccc\"></i></p></div></li>");
...
" style="float:right" target="_blank" class="more pt5">全部(<?php echo $_smarty_tpl->tpl_vars['notenum']->value;?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="biquu_d_placeholder mt60 mb40">
                        <a href="http://www.njupt.edu.cn/"><span class="biquu_d_placeholder"><img alt="在线物理实验平台" title="在线物理实验平台" src="__PUBLIC__/images/ads-lg.jpg"></span></a>
                    </div>
