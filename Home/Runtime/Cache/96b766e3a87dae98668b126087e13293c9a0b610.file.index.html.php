<?php /* Smarty version Smarty-3.1.6, created on 2016-07-10 18:57:12
         compiled from "./Home/Tpl\Video\index.html" */ ?>
<?php /*%%SmartyHeaderCode:2242657807e0e97a1b3-19424467%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2242657807e0e97a1b3-19424467',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57807e0eed1ed',
  'variables' => 
  array (
    'title' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_57807e0eed1ed')) {function content_57807e0eed1ed($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\function.html_options.php';
?><!DOCTYPE html>
<html>
    <head>
        <title>实验资源浏览</title>
        ...
        <div class="home_module row">
            <div class="container">
                ...
                <div class="col-md-8 oh">
                    ...
                    <div class="tt">
                        <h3><?php echo (($tmp = @$_smarty_tpl->tpl_vars['title']->value)===null||$tmp==='' ? "精选实验视频" : $tmp);?>
</h3>
                    </div>
