<?php /* Smarty version Smarty-3.1.6, created on 2016-07-10 18:55:54
         compiled from "./Home/Tpl\Video\play.html" */ ?>
<?php /*%%SmartyHeaderCode:266577fcc7b2b9441-43667757%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '266577fcc7b2b9441-43667757',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_577fcc7b80035',
  'variables' => 
  array (
    'vo' => 0,
    'iszan' => 0,
...
<?php if ($_valid && !is_callable('content_577fcc7b80035')) {function content_577fcc7b80035($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\edu\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>实验视频在线播放</title>
...
" class="f12" style="margin-right:200px">查看视频详情</a>        
                        </div>
                    </div>
                </div>
...
-->
                   ...
                   <div id="video" videoname="<?php echo $_smarty_tpl->tpl_vars['vo']->value['name'];?>
" videopic="<?php echo $_smarty_tpl->tpl_vars['vo']->value['picname'];?>
" style="position:relative;z-index:100;margin-left:10%;width:750px;height:500px"><div id="a1">
                 <script language="javascript"> 
                   var str = "<?php echo $_smarty_tpl->tpl_vars['vo']->value['name'];?>
";
                   var name = "<?php echo $_smarty_tpl->tpl_vars['vo']->value['name'];?>
".substr(0,str.length-4);
                document.write("<embed src="+"__PUBLIC__/Uploads/video/"+name+".swf width='700' height='500'></embed>");
                    </script>
